...
_G.Bracket_GUID = game:GetService("HttpService"):GenerateGUID(false)
...
Bracket.Utilities = {
	...
	s = function(Self, Object1, Object2)
...
Bracket.Elements = {
	Screen = function()
		...
		ScreenAsset.Name = "Bracket " .. _G.Bracket_GUID
	...
	Window = function(Window)
		...
		function Window.KeybindList(Self, KeybindList)
			...
			KeybindList.Size = Bracket.Utilities:GetType(KeybindList.Size, "UDim2", UDim2.new(0, 160, 0, 24))
			...
			--Bracket.Utilities.MakeResizeable(KeybindListAsset.Resize, KeybindListAsset, Vector2.new(160, 24), Vector2.new(896, 896), function(Size)
...
function Bracket:Window(Window)
	...
	function Window:Tab(Tab)
		...
		function Tab.AddConfigSection(Self, FolderName, Side)
			local ConfigSection = Self:Section({Name = "Configs", Side = Side}) do
